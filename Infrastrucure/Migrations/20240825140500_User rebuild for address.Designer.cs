...
namespace market_api.Migrations
{
    ...
    [Migration("20240825140500_User rebuild for address")]
    partial class Userrebuildforaddress
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Models.Domain.User", b =>
                {
            ...
            modelBuilder.Entity("Core.Models.Domain.User", b =>
                {
                    b.HasOne("Core.Models.Domain.ShippingAddress", "Address")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Core.Models.Domain.User", null)
                        .WithMany()
